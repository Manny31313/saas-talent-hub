...
const roles: Role[] = [
  {
    ...
    type: "Full-time",
    salary: "$120k–$180k OTE",
    tags: ["Sales", "Enterprise", "Series C"],
    posted: "2 days ago",
  },
  {
    id: "2",
    ...
    tags: ["Executive", "Leadership", "Series B"],
    posted: "3 days ago",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    type: "Full-time",
    salary: "$160k–$200k",
    tags: ["Marketing", "Leadership", "Series B"],
    posted: "1 week ago",
  },
  {
    id: "6",
    ...
    type: "Full-time",
    salary: "$85k–$110k",
    tags: ["RevOps", "Analytics", "Series C"],
    posted: "2 weeks ago",
  },
];
  ...
  >
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
      ...
      <div className="flex flex-col items-end gap-2 shrink-0">
        ...
        <Button variant="hero" size="sm" className="mt-auto">
